...
// doubt reply, support request, masterclass). Shown under the bell in the top bar.
const notificationSchema = new mongoose.Schema(
  {
    userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
    type: { type: String, default: 'info' }, // grade | quiz | assignment | announcement | doubt | support | webinar | info
