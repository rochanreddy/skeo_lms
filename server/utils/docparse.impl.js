// The parsing itself. This module runs ONLY inside the child process that
// docparse.js starts -- nothing on the request path imports it, which is what
// keeps mammoth and pdf-parse (and the megabytes they chew through) out of the
// API process entirely. Call the wrapper in docparse.js instead.
